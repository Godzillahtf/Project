  ...
  data () {
    return {
      formLabelAlign: {
        name: "IP CAMERA",
        id: "88",
        model: "DS-2CD3346WD-I",
        serialNumber: "DS-2CD3346WD-I20181127AACHC69551067",
        masterVersion: "V5.5.80 build 180911",
        codeVersion: "V7.3 build 180827",
        webVersion: "V4.0.1 build 180827",
        pluginVersion: "V3.0.6.46",
        aisleCount: "1",
        hardDiskCount: "0",
        alarmInputCount: "0",
        alarmOutputCount: "0",
